        ...
        <View style={styles.footer}>
            <TouchableOpacity onPress={() => router.push("/auth/swipe-screen")}>
                <Ionicons
                    name="home"
                    size={32}
                    color={pathname === "/auth/swipe-screen" ? "#1FA867" : "gray"}
                />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => router.push("/events/events-screen")}>
                <Ionicons
                    name="calendar"
                    size={32}
                    color={pathname === "/events/events-screen" ? "#1FA867" : "gray"}
                />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => router.push("/chats/chats-screen")}>
                <Ionicons
                    name="chatbubbles"
                    size={32}
                    color={pathname === "/chats/chats-screen" ? "#1FA867" : "gray"}
                />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => router.push("/profile/user-profile-screen")}>
                <Ionicons
                    name="person"
                    size={32}
                    color={pathname === "/profile/user-profile-screen" ? "#1FA867" : "gray"}
                />
            </TouchableOpacity>
        </View>
    );
